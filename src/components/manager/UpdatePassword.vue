            ...
            <div class="update-password-form">
              <el-form
                ...
                <el-form-item prop="oldPassword">
                  <el-input style="width: 70%;" v-model="manager.oldPassword" type="password"
                            placeholder="请输入旧密码"/>
                </el-form-item>

                <el-form-item prop="password">
                  <el-input style="width: 70%;" v-model="manager.password" type="password" placeholder="请输入新密码"/>
                </el-form-item>

                <el-form-item prop="confirmPassword">
                  <el-input style="width: 70%;" v-model="manager.confirmPassword" type="password"
                            placeholder="请输入确认密码"/>
                </el-form-item>
  ...
  methods: {
    ...
    submitForm() {
      ...
      this.$refs['ruleFormRef'].validate((valid) => {
        ...
        if (valid) {
          // 发送登录请求
          this.$http.put("/data/snack_platform/manager/updatePassword", this.manager).then(data => {
            // console.log("---------------",data)
            // 判断是否登录成功
            if (data && data.code === 200) {
              // 登录成功，跳转到管理页面
...
.update-password-el-form {
  margin: 0 auto;
}

/* 增加输入框高度 */
.update-password-el-form .el-input {
  margin: 2px auto;
}
