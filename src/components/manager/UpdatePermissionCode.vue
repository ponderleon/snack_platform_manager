          ...
          <div class="update-permission-code">
            ...
            <div class="update-permission-code-form">
              <el-form
                ...
                <el-form-item label="旧权限码" prop="oldPermissionCode">
                  <el-input style="width: 80%;" v-model="manager.oldPermissionCode" type="password"
                            placeholder="请输入确认密码"/>
                </el-form-item>

                <el-form-item label="新权限码" prop="newPermissionCode">
                  <el-input style="width: 80%;" v-model="manager.newPermissionCode" type="password"
                            placeholder="请输入确认密码"/>
                </el-form-item>

                <el-form-item label="验证码" prop="verificationCode">
                  <el-row :gutter="50" class="update-permission-code-captcha-row">
                    <el-col :span="11">
                      <el-input style="width: 90%;" v-model="manager.verificationCode" placeholder="请输入验证码"/>
                    </el-col>
                    <el-col :span="10" class="update-permission-code-captcha">
                      <img style="" :src="captchaImage" @click="refreshCode()" alt="验证码"/>
                    </el-col>
                  </el-row>
                </el-form-item>

                <el-form-item class="update-permission-code-container">
  ...
  data() {
    return {
      ...
      formRules: {
        ...
        oldPermissionCode: [{required: true, message: '请输入权限码', trigger: 'blur'},],
        newPermissionCode: [{required: true, message: '请输入权限码', trigger: 'blur'},],
        verificationCode: [
...
/* 验证码图片样式 */
.update-permission-code-captcha {
...
/*设置验证码图片样式*/
.update-permission-code-captcha img {
  width: 100%;
  height: 40px;
  cursor: pointer;
}
